...
context("Apple Pay", () => {
    ...
    describe('Checkout', () => {
        ...
        it('C4082: Apple Pay visible if available in browser (Checkout)', () => {
        ...
        it('C4080: Apple Pay hidden if not available in browser (Checkout)', () => {
    ...
    describe('Account', () => {
        ...
        it('C4081: Apple Pay hidden in account if available in browser (Account)', () => {
        ...
        it('C4083: Apple Pay hidden if not available in browser (Account)', () => {
