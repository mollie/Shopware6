...
class SubscriptionRemindedEvent extends Event implements CustomerAware, BusinessEventInterface, MailActionInterface, SalesChannelAware, MailAware
{
    ...
    {
        return 'mollie.subscriptions.renewal-reminder';
    }
