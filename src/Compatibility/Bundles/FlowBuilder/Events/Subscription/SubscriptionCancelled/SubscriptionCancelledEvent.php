...
class SubscriptionCancelledEvent extends Event implements CustomerAware, MailAware, SalesChannelAware, FlowEventAware
{
    ...
    {
        return 'mollie.subscription.cancelled';
    }
