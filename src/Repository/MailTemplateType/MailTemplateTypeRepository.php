...
class MailTemplateTypeRepository implements MailTemplateTypeRepositoryInterface
{
    ...
    /**
     * @param EntityRepository|EntityRepositoryInterface $mailTemplateTypeRepository
     */
    ...
    {
        return $this->mailTemplateTypeRepository->upsert($data, $context);
    }
    ...
    {
        return $this->mailTemplateTypeRepository->create($data, $context);
    }
    ...
    {
        return $this->mailTemplateTypeRepository->search($criteria, $context);
    }
