...
namespace Kiener\MolliePayments\Components\Subscription\Services\Mailer;
...
class MailerService
{
     ...
     */
    public function __construct(Mailer $mailer, EntityRepositoryInterface $salesChannelRepository, EntityRepositoryInterface $customer, SettingsService $settingsService, EntityRepositoryInterface $mailTemplateRepository, ConfigService $configService, EntityRepositoryInterface $product, LoggerInterface $logger)
    {
        $this->mailer = $mailer;
