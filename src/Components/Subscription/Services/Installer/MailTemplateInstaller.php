...
class MailTemplateInstaller
{
     ...
     */
    public function __construct(Connection $connection, EntityRepositoryInterface $repoMailTypes, MailTemplateRepositoryInterface $repoMailTemplates, EntityRepositoryInterface $repoSalesChannels)
    {
