...
class SubscriptionRepository
{
     ...
     */
    public function __construct(EntityRepositoryInterface $repoSubscriptions, MollieSubscriptionAddressRepositoryInterface $repoAddresses, EntityRepositoryInterface $repoHistory)
    {
