...
Application.addServiceProvider('MollieOrderDetailsService', (container) => {
    const initContainer = Application.getContainer('init');

    return new MollieOrderDetailsService(initContainer.httpClient, container.loginService);
});
